...
def run_Normalization(data_name):
    ...
    for i in range(line_nums):
        line = lines[i].strip()
        item_mat = line.split(',')
        x_mat[i, :] = item_mat[0:data.shape[1]]  # 获取51个特征
    ...
    numpy.savetxt(save_path + data_name + '_normal.csv', x_mat, delimiter=',')
