...
def get_coef_NChange_test(norm_data, batch_num, C_point_index, parameter):
    ...
    network_architecture = dict(n_hidden_enc_1=parameter['n_hidden_enc_1'],
                                # 1nd layer encode neurons
                                n_hidden_enc_2=parameter['n_hidden_enc_2'],
                                # 2nd layer encode neuron2
                                n_hidden_dec_1=parameter['n_hidden_dec_2'],
                                # 1nd layer decode neurons
                                n_hidden_dec_2=parameter['n_hidden_enc_1'],
