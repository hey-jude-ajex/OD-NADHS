...
def run_Normalization(data_name, index):
    global x_mat
    data_path = source_path + 'time-series-toNorm/' + data_name + "_normal.csv"
    fr = open(data_path)
    ...
    numpy.savetxt(save_path + "time-series-toMinmax/" + data_name + "_minmax.csv", x_mat, delimiter=',')
